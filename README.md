...
1. The script sends fake ARP packets to the **target** saying:  
   → “I am the gateway.”

2. Then it sends fake ARP packets to the **gateway** saying:  
   → “I am the target.”

3. Both machines start sending traffic through **your machine**.

4. This creates a **MITM position**.

5. When you exit, the program sends correct ARP packets to **fix the ARP table**.

## 👤 Author

GitHub: [**tahaisler24**](https://github.com/tahaisler24)
